# WelcomeMemphis — Shelby County Language Accessibility Map
...
Memphis is one of the most diverse cities in the South, yet many residents who speak little or no English struggle to find services that can communicate with them, such as hospitals, legal aid office, or a libraries. There is no easy way to see where these communities are concentrated or which nearby services are accessible to them.

## What WelcomeMemphis Does

- Displays a map of Shelby County color-coded by language spoken at home
- Lets users filter by language (Spanish, Vietnamese, Arabic, Chinese, French/Haitian Creole)
...
[https://rhodes-college-2026-hackathon-wa4o-a63ejs3ia.vercel.app/](https://rhodes-college-2026-hackathon-wa4o-a63ejs3ia.vercel.app/)
...
- **Brainstorming:** approach to feature implementation
- **Debugging:** layout and map rendering issues
- **Programming:** assistance with Leaflet.js setup, improved index.html to handle tract data, converting table data to data.json file 
